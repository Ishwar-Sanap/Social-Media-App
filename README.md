...
- Concepts
  ...
  - For real-time messaging and notifications, we are using socket.io-client to establish a WebSocket connection with the backend server.
    This allows us to receive real-time updates for new messages and notifications without needing to refresh the page, providing a seamless user experience.
